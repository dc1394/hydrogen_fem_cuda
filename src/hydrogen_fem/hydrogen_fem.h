...
#include <Eigen/Core>               // for Eigen::MatrixXf, Eigen::VectorXf
...
namespace hydrogen_fem {
    ...
    */
    ...
    private:
        ...
        */
        [[nodiscard]]
        float get_A_matrix_element(std::int32_t e, float le, std::int32_t p, std::int32_t q) const;
        ...
        */
        [[nodiscard]]
        float get_B_matrix_element(std::int32_t e, float le, std::int32_t p, std::int32_t q) const;
    ...
    private:
        ...
        */
        ...
        /*!
            積分区間の上限
        */
        static auto constexpr R_MAX = 50.0f;

        //! A private member variable (constant expression).
        /*!
            積分区間の上限
        */
        static auto constexpr R_MIN = 0.0f;

        //! A private member variable.
        /*!
            エネルギー固有値
        */
        std::vector<float> eigenval_;
        ...
        */
        ...
        /*!
            各要素の長さ
        */
        std::valarray<float> length_;

        //! A private member variable.
        /*!
            左辺要素係数行列
        */
        boost::multi_array<float, 3> mat_A_ele_;

        //! A private member variable.
        /*!
            右辺要素係数行列
        */
        boost::multi_array<float, 3> mat_B_ele_;
        ...
        */
        ...
        /*!
            各要素のLocal節点のr座標
        */
        boost::multi_array<float, 2> node_r_ele_;

        //! A private member variable.
        /*!
            Global節点のr座標
        */
        std::valarray<float> node_r_glo_;
